...
c Reading the input parameters from iv.in: 
c (see iv.in for a explanation of the different parameters)
...
c Calculation of the maximum number of MAR needed: nmax
...
c          do w=-4,4,0.01
c           write(12,*) w,real(zintegrand(w)),
c     1      real((zintegrand(w)-real(zintegrand(w)))/(0.0,1.0))
c          enddo
